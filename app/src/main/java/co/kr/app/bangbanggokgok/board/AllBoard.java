...
public class AllBoard implements Parcelable{

	private String deposit , area , one_report , main_img, option_01, option_02, option_03, option_04, option_05;
	public AllBoard() {
    }
	public AllBoard(Parcel in) {
	       readFromParcel(in);
	    }
	public AllBoard(String deposit, String area, String one_report , String main_img , String option_01 ,
	...
	public static final Parcelable.Creator<AllBoard> CREATOR = new Parcelable.Creator() {
		public Object createFromParcel(Parcel in) {
			return new AllBoard(in);
		}
