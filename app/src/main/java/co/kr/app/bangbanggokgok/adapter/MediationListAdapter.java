...
public class MediationListAdapter extends BBGGCommonAdapter<AllListModel> {


    public MediationListAdapter(Context context, ArrayList<AllListModel> datas) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(position == 0) {
            ...
            if(convertView == null) convertView = mLayoutInflater.inflate(R.layout.mediation_list_section_first,
                    parent, false);
            return convertView;
        }
        ...
        if(position == 5) {
            ...
            if(convertView == null) convertView = mLayoutInflater.inflate(R.layout.mediation_list_section_second,
                    parent, false);
            return convertView;
        }
