...
public class MyBoard implements Parcelable{

	private String deposit , area , one_report , main_img, option_01, option_02, option_03, option_04, option_05;
	public MyBoard() {
    }
	public MyBoard(Parcel in) {
	       readFromParcel(in);
	    }
	public MyBoard(String deposit, String area, String one_report , String main_img , String option_01 ,
