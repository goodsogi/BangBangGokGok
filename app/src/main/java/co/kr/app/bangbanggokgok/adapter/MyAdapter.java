...
public class MyAdapter extends BaseAdapter{
	...
	private ArrayList<MyBoard> arrData;
	private Activity activity;
	private static LayoutInflater inflater;


	public MyAdapter(Context context,Activity a, ArrayList<MyBoard> m_board ) {
		activity = a;
		arrData = m_board;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		View vi=convertView;
		if (convertView == null) {
			vi = inflater.inflate(R.layout.activity_mylistview, null);
		}

		MyBoard board = arrData.get(position);
