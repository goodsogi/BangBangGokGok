...
public class DirectdealActivity extends FragmentActivity implements PlusOnGetDataListener {
    private static final int GET_DIRECT_ROOM_LIST = 22;
    ...
    private void setUpSoftMenu() {
        ...
        softmenu.setSofeMenuEvent(2, this);
    }
    ...
    private void makeList(ArrayList<AllListModel> datas) {
        ...
        AllListAdapter adapter = new AllListAdapter(getApplicationContext(), datas);
    ...
    AdapterView.OnItemClickListener mItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView parent, View view, int position,
            ...
            Intent board = new Intent(DirectdealActivity.this, AllListDetailActivity.class);
    ...
    public void getDataFromServer() {
        new PlusHttpClient(this, this, false).execute(GET_DIRECT_ROOM_LIST,

                BBGGApiConstants.GET_DIRECT_ROOM_LIST,
                new AllListParser());
    }
}